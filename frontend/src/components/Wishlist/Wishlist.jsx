          ...
          <>
            <div>
              ...
              <div className={`${styles.noramlFlex} p-4`}>
                ...
                <h5 className="pl-2 text-[20px] font-[500]  text-[#49108B]">
    ...
    <div className="border-b p-4">
      <div className="w-full 800px:flex items-center">
        ...
        <div className="pl-[5px]">
          <h1 className="font-[600] text-[18px]">{data.name}</h1>
          <h4 className="font-[600] pt-3 800px:pt-[3px] text-[17px] text-[#49108B] font-Roboto">
            INR₹{totalPrice}
          </h4>
        </div>
